...
===================
To edit the source files using Eclipse C++ Juno
...
3. Select BPlusTree source folder which has makefile.
4. Finish
5. File -> Import -> C/C++ -> C/C++ Project Settings. Select "eclipsecdt.xml"
   in src_bmlist folder. Finish.
6. Right click on project BitMat -> Index -> Rebuild Index.
7. Clean the project and rebuild.

Done.. with no indexer/parser errors!
