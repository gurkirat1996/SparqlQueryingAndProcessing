...
int max_join_var = 101
map<int, int> val;
int neg=-max_join_var, neg2=-1;//MAX_JVARS-1; //to assign join/non-join values
...
void dfs2(SPARQLParser::PatternGroup& group, string strlevel){
